...
public class carbono extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtContenido2.setText("\nEsta es la primera etapa de la fase oscura, momento en que se fija el carbono. En esta etapa, el carbono que proviene del CO2 de la atmósfera se fija dentro de un\ncarbohidrato. Para ello existen tres variaciones: Fijación del carbono C3, fijación del carbono C4 y CAM. A continuación, analizamos cada una de ellas.                                                                      \n1)  Fijación de carbono C3: se fija el CO2 directamente en el Ciclo de Calvin sin fijaciones previas. La explicación científica explica que la enzima rubrico cataliza la reacción entre la ribulosa-1, 5-bifosfato con el CO2, de este\nmodo se crea una molécula de seis carbonos que se separa en dos moléculas de fosfoglicerato con tres átomos de carbono.\n \n2)Fijación de carbono C4: Antes de ingresar el CO2 en el Ciclo de Calvin, reacciona con el fosfoenolpiruvato y produce oxalacetato, que posteriormente se convertirá en malato, una molécula de 4 carbonos. A continuación, el malato se transporta a las células y se descarboxila para\nproducir el CO2 que se requiere en el Ciclo de Calvin.          \n3) Fijación de carbono en plantas CAM: En esta ocasión, el proceso es parecido al C4, pero tiene lugar en las crasuláceas. Las plantas de este tipo cierran sus estomas de día y no pueden absorber CO2.\n\nPor tanto, para realizar la fotosíntesis absorben el CO2 por la noche, transformándolo en malato y suministrando este durante el día para que la planta puede realizar\nel Ciclo de Calvin.                                                                                                                   ");
